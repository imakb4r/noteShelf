...
void _noteSerialize(
  ...
  writer.writeString(offsets[0], object.discription);
...
Note _noteDeserialize(
  ...
  final object = Note(
    discription: reader.readString(offsets[0]),
    id: id,
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionEqualTo(
    String value, {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'discription',
        value: '',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> discriptionIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'discription',
        value: '',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastMod',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastModBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  QueryBuilder<Note, Note, QAfterSortBy> sortByDiscription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'discription', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByDiscriptionDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> sortByLastMod() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastMod', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByLastModDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastMod', Sort.desc);
    });
  }
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  QueryBuilder<Note, Note, QAfterSortBy> thenByDiscription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'discription', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByDiscriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'discription', Sort.desc);
    });
  }
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByLastMod() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastMod', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByLastModDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastMod', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  QueryBuilder<Note, Note, QDistinct> distinctByDiscription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QDistinct> distinctByLastMod() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastMod');
    });
  }
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, String, QQueryOperations> discriptionProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, DateTime, QQueryOperations> lastModProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastMod');
    });
  }
